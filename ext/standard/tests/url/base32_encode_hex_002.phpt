--TEST--
Test base32_encode() function : basic functionality - check algorithm round trips with hex alphabet
--FILE--
<?php
/*
...
foreach($values as $str) {
    ...
    $enc = base32_encode(decoded: $str, alphabet: PHP_BAS32_HEX);
    $dec = base32_decode(encoded: $enc, alphabet: PHP_BAS32_HEX);
